...
$quorum --datadir qdata/dd1 init raft-genesis.json
...
$quorum --datadir qdata/dd2 init raft-genesis.json
...
$quorum --datadir qdata/dd3 init raft-genesis.json
...
$quorum --datadir qdata/dd4 init raft-genesis.json
...
# geth --datadir qdata/dd5 init raft-genesis.json
...
# geth --datadir qdata/dd6 init raft-genesis.json
...
# geth --datadir qdata/dd7 init raft-genesis.json